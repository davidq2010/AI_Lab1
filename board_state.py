...
class BoardStateManager:
    ...
    def __init__(self):
        ...
        self.vehicle_list_1 = [Vehicle(Position_2D(2, 5), 2, False), 
                               Vehicle(Position_2D(1, 0), 2, False), 
                               Vehicle(Position_2D(5, 4), 2, True),
                               Vehicle(Position_2D(3, 3), 3, True),
                               Vehicle(Position_2D(4, 2), 4, True), 
                               Vehicle(Position_2D(3, 3), 2, False)]
        ...
        self.vehicle_list_3 = [Vehicle(Position_2D(2, 5), 2, False)]

        self.vehicle_list_4 = [Vehicle(Position_2D(2, 5), 2, False),
                               Vehicle(Position_2D(5, 4), 2, True)]

        self.initial_state_A = [Vehicle(Position_2D(2, 5), 2, False), 
                               Vehicle(Position_2D(3, 4), 2, True),
                               Vehicle(Position_2D(4, 4), 2, True),
                               Vehicle(Position_2D(5, 4), 2, True),
                               Vehicle(Position_2D(5, 3), 2, False), 
                               Vehicle(Position_2D(3, 1), 3, True),
                               Vehicle(Position_2D(1, 2), 3, True),
                               Vehicle(Position_2D(3, 0), 2, False)]
        self.initialize()
    ...
    def initialize(self):
        ...
        # Init Vehicles
        self.initial_vehicles = self.initial_state_A
